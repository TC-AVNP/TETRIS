...
;;;Devolve o maior elemento de uma lista (em caso de empate e o mais a esq.)
...
;;; escolhe-novo-no: lista -> no
;;  funcao usada para escolher o novo no da lista de abertos
;;  escolhe o no com menor custo e mais a direita na lista			
...
;;; esta-contido: lista x elemento -> logico
;;  Verifica se existe alguma ocorrencia de um dado elemento na lista
...
;;; constroi-caminho: no -> lista
;;  Constroi todo o caminho desde um dado no ate ao no inicial
...
;;; heuristica-holes: tabuleiro -> inteiro
;;  devolve o numero de "buracos" que existe num tabuleiro
(defun heuristica-holes (tabuleiro)
	(let
		((holes 0))
...
;;; heuristica-linhas: tabuleiro -> inteiro
;;  devolve o numero de linhas completas num tabuleiro
(defun heuristica-linhas (tabuleiro) 
	(let
		((linhas 0))
...
;;; heuristica-altura: tabuleiro -> inteiro
;;  devolve a soma da altura de cada coluna no tabuleiro
...
;;;heuristica-desfasamento: tabuleiro -> inteiro
;; Da a variacao entre as alturas das colunas do tabuleiro. 
...
;;;melhor-heuristica: estado -> inteiro
;; juncao das heuristicas anteriores
;; cada heuristica e multiplicada por uma constante que representa o seu peso
(defun melhor-heuristica(estado)
	(let
...
(defun procura-best (tab pecas)
		...
		(let
			...
			(procura-A* problema #'melhor-heuristica)))
